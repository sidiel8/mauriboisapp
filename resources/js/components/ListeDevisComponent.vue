                  ...
                  <table class="table table-striped table-sm">
                      <thead>
                        <tr>
                          ...
                          <th scope="col">Numero Devis/Facture <i class="fas fa-search"></i></th>
                      ...
                      <tbody>
                          ...
                          <tr  class="alert alert-danger" v-for="devis in filteredDevis" :key="devis.id" :id="devis.id" >
                            <td scope="row" ><b>{{devis.numero_devis}}</b></td>
  ...
  computed:{
   ...
   if(this.search==''){
    ...
    return  sss.filter((d)=>{
           ...
           return d.numero_devis.toString().match(this.search);
